...
def Add():
    filename='Addbatch.py'
    os.system(filename)
    root.destroy()
    exit()

def Update():
    filename='Updatebatch.py'
    os.system(filename)
    root.destroy()
    exit()

def Delete():
    filename='Deletebatch.py'
    os.system(filename)
    root.destroy()
    exit()
...
def search():
    q2=q.get()
    query="SELECT * FROM `batch` WHERE Batch_Name LIKE '%"+q2+"%'"
...
root.title("Batch Management Dashboard")
...
lbl=Label(root,text="Batch Management Dashboard",fg="#ff9999",font=("Helvetica",46,"bold"),bg="white").place(x=330,y=40)
lbl=Label(root,text="Batch Management Options",fg="#ff9999",font=("Helvetica",14),bg="white").place(x=85,y=250)
...
Box=Label(root,text="",bg="#a6a6a6").place(x=320,y=263,width=78,height=2)
...
btn=Button(root,text="ADD BATCH",fg="white",font=("Helvetica",15),bg="#f88600",bd="0",activebackground="#f88600",command=Add).place(x=175,y=330)
btn=Button(root,text="UPDATE BATCH",fg="white",font=("Helvetica",15),bg="#f88600",bd="0",activebackground="#f88600",command=Update).place(x=165,y=406)
btn=Button(root,text="DELETE BATCH",fg="white",font=("Helvetica",15),bg="#f88600",bd="0",activebackground="#f88600",command=Delete).place(x=165,y=485)
...
columns=(
"BATCH ID", "BATCH NAME", "BATCH YEAR", "BATCH INTAKE"),
...
# ==========================TreeView Heading====================
student_tree.heading("BATCH ID", text="BATCH ID")
student_tree.heading("BATCH NAME", text="BATCH NAME")
student_tree.heading("BATCH YEAR", text="BATCH YEAR")
student_tree.heading("BATCH INTAKE", text="BATCH INTAKE")
student_tree["show"] = "headings"

# ==========================TreeView Column====================
student_tree.column("BATCH ID", width=170)
student_tree.column("BATCH NAME", width=170)
student_tree.column("BATCH YEAR", width=200)
student_tree.column("BATCH INTAKE", width=150)
