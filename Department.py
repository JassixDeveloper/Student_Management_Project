...
def Add():
    filename='Adddepartment.py'
    os.system(filename)
    root.destroy()
    exit()

def Update():
    filename='Updatedepartment.py'
    os.system(filename)
    root.destroy()
    exit()

def Delete():
    filename='Deletedepartment.py'
    os.system(filename)
    root.destroy()
    exit()
...
def search():
    q2=q.get()
    query="SELECT * FROM `department` WHERE Department_Name LIKE '%"+q2+"%'"
...
root.title("Department Management Dashboard")
...
lbl=Label(root,text="Department Management Dashboard",fg="#ff9999",font=("Helvetica",46,"bold"),bg="white").place(x=330,y=40)
lbl=Label(root,text="Department Management Options",fg="#ff9999",font=("Helvetica",14),bg="white").place(x=85,y=250)
...
Box=Label(root,text="",bg="#a6a6a6").place(x=372,y=263,width=28,height=2)
...
btn=Button(root,text="ADD DEPARTMENT",fg="white",font=("Helvetica",15),bg="#f88600",bd="0",activebackground="#f88600",command=Add).place(x=145,y=330)
btn=Button(root,text="UPDATE DEPARTMENT",fg="white",font=("Helvetica",15),bg="#f88600",bd="0",activebackground="#f88600",command=Update).place(x=125,y=406)
btn=Button(root,text="DELETE DEPARTMENT",fg="white",font=("Helvetica",15),bg="#f88600",bd="0",activebackground="#f88600",command=Delete).place(x=125,y=485)
btn=Button(root,text="GO TO DASHBOARD",fg="white",font=("Helvetica",15),bg="#f88600",bd="0",activebackground="#f88600",command=dashboard).place(x=135,y=565)
...
# ==========================TreeView Heading====================
student_tree.heading("DEPARTMENT ID", text="DEPARTMENT ID")
student_tree.heading("DEPARTMENT CODE", text="DEPARTMENT CODE")
student_tree.heading("DEPARTMENT NAME", text="DEPARTMENT NAME")
student_tree["show"] = "headings"

# ==========================TreeView Column====================
student_tree.column("DEPARTMENT ID", width=170)
student_tree.column("DEPARTMENT CODE", width=170)
student_tree.column("DEPARTMENT NAME", width=170)
