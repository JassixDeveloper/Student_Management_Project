...
def Delete():
    ...
    if dcode.get == "" or dname.get() == "":
        ...
        cursor.execute("DELETE FROM `department` WHERE Department_Name=%s VALUES(?)",(name1))
        conn.commit()
        dcode.set("")
        dname.set("")
...
Head=Label(frame1,text="Department Deletion Form",font=("Helvetica",50,"bold"),bg="white",fg="#ff9999").place(x=350,y=20)
