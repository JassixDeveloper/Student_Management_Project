...
def Add():
    filename='Addcourse.py'
    os.system(filename)
    root.destroy()
    exit()

def Update():
    filename='Upadetcourse.py'
    os.system(filename)
    root.destroy()
    exit()

def Delete():
    filename='Deletecourse.py'
    os.system(filename)
    root.destroy()
    exit()
...
def search():
    q2=q.get()
    query="SELECT * FROM `course` WHERE Course_Name LIKE '%"+q2+"%'"
...
root.title("Course Management Dashboard")
...
lbl=Label(root,text="Course Management Dashboard",fg="#ff9999",font=("Helvetica",46,"bold"),bg="white").place(x=330,y=40)
lbl=Label(root,text="Course Management Options",fg="#ff9999",font=("Helvetica",14),bg="white").place(x=85,y=250)
...
btn=Button(root,text="ADD COURSE",fg="white",font=("Helvetica",15),bg="#f88600",bd="0",activebackground="#f88600",command=Add).place(x=170,y=330)
btn=Button(root,text="UPDATE COURSE",fg="white",font=("Helvetica",15),bg="#f88600",bd="0",activebackground="#f88600",command=Update).place(x=155,y=406)
btn=Button(root,text="DELETE COURSE",fg="white",font=("Helvetica",15),bg="#f88600",bd="0",activebackground="#f88600",command=Delete).place(x=155,y=485)
...
# ==========================TreeView Heading====================
student_tree.heading("COURSE ID", text="COURSE ID")
student_tree.heading("COURSE NAME", text="COURSE NAME")
student_tree.heading("COURSE DURATION", text="COURSE DURATION")
student_tree.heading("COURSE CREDIT", text="COURSE CREDIT")
student_tree["show"] = "headings"

# ==========================TreeView Column====================
student_tree.column("COURSE ID", width=170)
student_tree.column("COURSE NAME", width=170)
student_tree.column("COURSE DURATION", width=200)
student_tree.column("COURSE CREDIT", width=150)
